...
- Google Form ID: `1FAIpQLSeWYq4nROWTPU8hvwwu8Pvm1-qGNB8DkeIo001dFaPC_HsR7g`
...
3. Copy `ScriptProperties` values for `BOOKING_URL`, `EXPECTED_FORM_ID`, and `INTERNAL_NOTIFY_EMAIL`.
